...
from code_review_mas.common.agent_runner import AgentRunner
from code_review_mas.common.base_agent import BaseAgent
from code_review_mas.common.utils import get_mcp_server_config, init_api_key
...
class SerenaAgent(BaseAgent):
    ...
    async def init_agent(self):
        ...
        config = get_mcp_server_config(server_name="serena")
